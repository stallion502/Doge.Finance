//
//  DevWalletTransactionsController.swift
//  PoocoinV2
//
...
class DevWalletTransactionsController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupUI()
        loadData()
        navigationItem.title = "Wallet transactions"
    ...
    @objc private func openBSCSCan() {
        guard let url = URL(string: "https://bscscan.com/txs?a=\(walletAdress)") else { return }
    ...
    private func setupUI() {
        ...
        tableView.register(UINib(nibName: "WalletTransactionCell", bundle: .main), forCellReuseIdentifier: "WalletTransactionCell")
    ...
    private func loadData() {
        activityIndicator.startAnimating()
        ApolloManager.shared.walletTransactions(address: walletAdress) { [weak self] result in
...
extension DevWalletTransactionsController: UITableViewDelegate, UITableViewDataSource {
